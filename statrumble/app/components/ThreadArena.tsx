...
function buildQuoteSentence(snapshot: unknown) {
  ...
  if (summary.beforeAvg === null) {
    return `Selected range average is ${selectedAvg} (n=${selectedN}). No prior-range data; change not computed.`;
  }
  ...
  return `Selected range average is ${selectedAvg} (n=${selectedN}); prior range average is ${beforeAvg} (n=${beforeN}); change is ${deltaAbs} / ${deltaRelPercent}%.`;
}
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  const confirmed = window.confirm("This may incur costs. Re-run the referee?");
