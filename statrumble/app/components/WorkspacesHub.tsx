      ...
      <div className="rounded-lg border border-zinc-200 bg-white p-5">
        <div className="flex items-baseline justify-between gap-2">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-600">Review role, joined_at, and invite status, then switch as needed.</p>
          </div>
              ...
              <li key={workspace.id} className="rounded-md border border-zinc-200 bg-zinc-50 p-4">
                ...
                {isLastOwner ? (
                  <p className="mt-2 text-xs text-amber-700">
                    You cannot leave as the last owner. Assign another owner or delete the workspace.
                  </p>
                ) : null}
