...
import type { MemberWorkspaceRow } from "@/lib/db/workspaces";
...
export default function WorkspacesHub({ workspaces, activeWorkspaceId }: WorkspacesHubProps) {
                ...
                <div className="flex flex-wrap items-start justify-between gap-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <button
                      ...
                      disabled={isLeaving || isSwitching}
